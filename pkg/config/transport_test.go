...
var testInputs = []string{
	...
	`{"app": {"version": "6.4.1"}, "device": {}}`,                                                                                                                          // Empty Device object
	`{"app": {"version": "6.4.1"}, "device": {"location": {}}}`,                                                                                                            // Empty Location object
	`{"app": {"version": "6.4.1"}, "device": {"location": {"locale": "en_GB"}}}`,                                                                                           // TimezoneOffset missing
